    ...
    public class SceneDownloader : MonoBehaviour
    {
        ...
        public IEnumerator ChangeState(SceneSession state)
        {
            ...
            switch (state){
                ...
                case SceneSession.DOWNLOADING:
                    //print("SceneSession.DOWNLOADING");
        ...
        public IEnumerator DownloadViewList(string username, string password)
        {
            ...
            if (webRequest.result != UnityWebRequest.Result.Success)
            {
                ...
                //NewMenuManager.singleton.UserLoginFailed();
            ...
            else
            {
                ...
                foreach (JMARSScene.Metadata m in userScenes)
                {
                    ...
                    //scene.thumbnail_texture = _thumbnailImg;
        ...
        public IEnumerator DownloadJMARSSceneData(string jsonURL)//, bool loadScreen)
        {
            ...
            /*if (jsonURL == "") //custom terrain
            {
                var url = "https://cm.mars.asu.edu/api/vr/viewScene.php?access_key=" + NewUIScript.singleton.jmarsScene.access_key; //gets access key from the JMARS scene selected from in-game UI
                terrainURL = url;
            }
            else //sample terrain
            {
            ...
            if (currentScene != null)
            {
                ...
                foreach (var layer in currentScene.layers)
                {
                    ...
                    */
                    ...
                    {
                        //print("No data layers! Using height as a datalayer");
                        //HeightMapToData(heightData, currentScene.units);
                    }
                }
        ...
        public void ConvertNumericData(JMARSScene.Layer.LayerData data, byte[] byte_array)
        {
            ...
            switch (data.data_type)
            {
                ...
                case "int":
                    ...
                    if (GameState.generateDataImages)
                    {
                        //print("Average = " + int_layer_data.Average());
        ...
        public IEnumerator DownloadNumericData(JMARSScene.Layer layer, byte[] byte_array = null)
        {
            foreach (var data in layer.layer_data)
            {
                ...
                {
                    if(byte_array == null) //NOT a sample terrain
                    {
                ...
                {
                    Debug.LogError("Per Pixel Flag Error");
                }
            }
        }
        ...
        public Texture2D DataToHeightMapFloat(byte[] bytes, int width, int height)
        {
            ...
            //print("The size of the byte array is: " + (bytes.Length / 4) + "x4");
            ...
            _texture.Apply();
            return _texture;
            /*DebugShowStringOfValues(2000, _texture);
            DebugShowStringOfValues(-2000, _texture);
            DebugShowNegativeValues(_texture);*/
        }
        ...
        {
            //Floats are 32-bit, or 4 bytes
            //Shorts are 16-bit, or 2 bytes 
            ...
            {
                pixelstring += newnewpixels[i] + ",";
            }
            print("Pixel string = " + pixelstring);*/
            ...
            //DebugShowStringOfValues(20, _texture);
        ...
        {
            //Debug.Log("Attemping to download texture from " + url);
        ...
        void DebugShowNegativeValues(Texture2D texture)
        {
            ...
            //print("Negative pixels ("+count+")= " + pixelstring);
